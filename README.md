...
В Модуле  plgn_db1 вынесены все API функции. В модуле main проходят все основные рассчеты. В модуле plgn_db1_sup реализованы наблюдатели, необходимые для работы программы.
